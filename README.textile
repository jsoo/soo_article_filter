...
Code preview and compiled (ready-to-install) downloads available "on the author's website":http://ipsedixit.net/txp/80/soo_article_filter (latest release only) and "on GitHub":https://github.com/jsoo/soo_article_filter (all release versions).
...
Thanks to "net-carver":https://github.com/netcarver for clueing me in to MySQL temporary tables.
